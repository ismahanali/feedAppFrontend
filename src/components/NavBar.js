...
const NavBar = ({ pageTitle = "Feed App" }) => {
  ...
  ////this function is called on click of the logout button
  //we are calling the logout function provided by our application context -which removes the token from cookies /and sets the userData as undefined
  const logout = () => {
    appContext.logout();
  };
  return (
